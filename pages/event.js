...
function Event({ query }) {
  ...
  const downloadTXT = () => {
    ...
    const text = data.event.voters
      .map((voter, _) => `https://cbre-quadratic-voting.netlify.app/vote?user=${voter.id}`)
      .join("\n");
    ...
    <Layout event>
      ...
      <div className="event">
        ...
        <div className="event__section">
          ...
          <input
            value={`https://cbre-quadratic-voting.netlify.app/event?id=${query.id}`}
            readOnly
          />
        </div>
        ...
        data ? (
          <>
            ...
            <div className="event__section">
              ...
              <input
                value={`https://cbre-quadratic-voting.netlify.app/event?id=${query.id}&secret=${query.secret}`}
                readOnly
              />
            </div>
          ...
          <div className="event__section">
            ...
            <textarea
              ...
              value={data.event.voters
                .map(
                  (voter, _) => `https://cbre-quadratic-voting.netlify.app/vote?user=${voter.id}`
                )
                .join("\n")}
              readOnly
            />
